...
//Contador de poblacion total
$poblacionTotal = 0;

// Muestra los datos de las provincias y calcula la población total de cada comunidad.
foreach ($comunidades as $comunidad => $valores) {
    ...
    foreach ($valores['provincias'] as $provincia => $datosProvincia) {
        $poblacionTotal += $datosProvincia['poblacion'];
    }
    echo "-Poblacion total: " . $poblacionTotal;
    $poblacionTotal = 0;
}
