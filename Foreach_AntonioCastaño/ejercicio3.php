...
// ACTIVIDAD3 Añado una nueva comunidad
$comunidades['Madrid'] = [
    'provincias' => [
        'Madrid' => ['poblacion' => 3277123],
    ],
    'capital' => ['Madrid' => [
        'poblacion' => 3277123,
        'informacion_adicional' => 'Ciudad capital de España y sede del Gobierno.'
    ]],
];
...
foreach ($comunidades as $comunidad => $valores) {
    ...
    //ACTIVIDAD2 Muestro los datos de la capital
    foreach ($valores['capital'] as $capital => $datosCapital) {
        echo "<li><b>Capital: " . $capital . "</b></li>";
        echo "<ul>";
        foreach ($datosCapital as $dato => $valor) {
            echo "<li>" . $dato . ": " . $valor . "</li>";
        }
        echo "</ul>";
    }

    //ACTIVIDAD2 Muestro el nombre de las provincias
    foreach ($valores['provincias'] as $provincia => $datosProvincia) {
        echo "<li>" . $provincia . "</li>";
        echo "<ul>";
        // Muestro la población de las provincias
        echo "<li>Población total: " . $datosProvincia['poblacion'] . "</li>";
        echo "</ul>";
    }
